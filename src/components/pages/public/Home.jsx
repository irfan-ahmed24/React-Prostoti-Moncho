...
export default function Home() {
  return (
    <div className="p-5">
      <h1 className="my-3 font-semibold dark:text-gray-300">ড্যাশবোর্ড</h1>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        <div className="bg-white dark:bg-[#021330] rounded-lg shadow p-5">
          <div className="text-center">
            <div className="flex justify-center">
              <FaGraduationCap className="text-4xl text-pink-700" />
            </div>
            <h1 className="text-xl font-semibold mt-2 dark:text-gray-300">
              পড়াশোনা
            </h1>
            <p className="text-sm mt-2 opacity-80 dark:text-gray-300">
